...
func TestBalanceDao_GetByAccountAndSymbol2(t *testing.T) {
	...
	actBalance := BalanceDaoSqlite.GetByAccountAndSymbol(account, "DAI", 18)
	...
	actBalance2 := BalanceDaoSqlite.GetByAccountAndSymbol(account, "DAI", 18)
	...
	actBalance3 := BalanceDaoSqlite.GetByAccountAndSymbol(account, "DAI", 18)
